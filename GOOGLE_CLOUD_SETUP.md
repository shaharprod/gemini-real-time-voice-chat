...
### שלב 2א: הפעל Google Search Grounding (לחיפוש באינטרנט)

אם אתה רוצה שהחיפוש באינטרנט יעבוד:

1. בתפריט, לך ל-**APIs & Services** → **Library**
2. חפש **"Google Search Grounding API"** או **"Grounding API"**
3. אם מוצא - לחץ עליו ולחץ **"Enable"**
4. **אם לא מוצא** - זה אומר שהחיפוש אולי לא נתמך ב-Live API, או שצריך להפעיל משהו אחר

**הערה**: לא כל ה-models תומכים בחיפוש. אם זה לא עובד, יכול להיות שצריך model אחר או שזו תכונה שדורשת הרשאות נוספות.
